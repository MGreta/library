...
<div class="panel panel-primary">
  <div class="panel-heading">Vėluojamos dienos kaina</div>
      ...
      <input type="hidden" name="_token" value="{{ csrf_token() }}">
    	...
    	<div class="form-group">
       	<div class="col-sm-offset-2 col-sm-10">
       		<button type="submit" name="create" value="create" class="btn btn-primary">Išsaugoti</button>
       	</div>
      </div>
    </form>
  </div>
...
<div class="panel panel-primary">
  <div class="panel-heading">Kiek dienų vartotojas gali turėti knygą</div>
  <div class="panel-body">
