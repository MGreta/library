    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">Pridėti žanrą</div>
...
@endif
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-primary">
                <div class="panel-heading">Žanrai</div>
                <div class="panel-body">
                    <table class="table table-striped table-hover table-condensed">
                        <thead>
                            <tr class="info">
                                <th>#</th>
                                <th><a href="{{ action('GenresController@order') }}">Žanras</a></th>
                                <th>Knygos pagal žanrą</th>
                                @if (Auth::user())
                                @if (Auth::user()->hasRole("admin"))
                                <th>Veiksmas</th>
                                @endif
                        ...
                        <tbody>
                            @if ($genres->count())
                                @for ($i = 0; $i < count($genres); $i++)
                                    <tr>
                                        <th>{{ $i+1 }}</th>
                                            <td><a href="/genres/{{ $genres[$i]->id }}/books">{{ $genres[$i]->genre }}</a></td>
                                            <td>{{ get_books_by_genre($genres[$i]->id) }}</td>
                                            @if (Auth::user())
                                            @if (Auth::user()->hasRole("admin"))
                                            <td>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            @include ('partials.notice')
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-sm-2 control-label" for="title">Žanras</label>
                                                                    <div class="col-sm-10">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <h4 class="modal-title">Panaikinti žanrą</h4>
                                                            </div>
                                                            <div class="modal-body">
